...
def style_corr_hist(filename_root, hist_name, filename_graphic, ylim=(0, 0.0001), verb=False):
...
if __name__ == '__main__':
    for pt_range in ['', '_400_450', '_450_500', '_500_550', '_550_600', '_600_650', '_650_700']:
        style_corr_hist(filename_root='correlator-joined.root',
                        ...
                        filename_graphic='/correlator_hist'+pt_range+'.png', ylim=(0, 0.0001), verb=True)
