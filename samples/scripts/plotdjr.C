...
//from https://github.com/CMS-SUS-XPAG/GenLHEfiles/blob/7cf643e3375eda3cfdb815f4cdc6a769341e8713/GridpackWorkflow/test/scripts/plotdjr.C
...
void plotdjr(TChain * tree, const TString & outputbase);
...
void plotdjr( TChain * tree, const TString & outputbase) {
  ...
  //pad[0]->cd();
  makeplot(TString::Format("%s_%s",outputbase.Data(),"djr0"),tree,weight,"log10(GenEvent.DJRValues_[0])","DJR 0->1",nbins,djrmin,djrmax);
  //pad[1]->cd();
  makeplot(TString::Format("%s_%s",outputbase.Data(),"djr1"),tree,weight,"log10(GenEvent.DJRValues_[1])","DJR 1->2",nbins,djrmin,djrmax);
  //pad[2]->cd();
  makeplot(TString::Format("%s_%s",outputbase.Data(),"djr2"),tree,weight,"log10(GenEvent.DJRValues_[2])","DJR 2->3",nbins,djrmin,djrmax);
  //pad[3]->cd();
  makeplot(TString::Format("%s_%s",outputbase.Data(),"djr3"),tree,weight,"log10(GenEvent.DJRValues_[3])","DJR 3->4",nbins,djrmin,djrmax);
